...
public class CompleteView_Tab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complete_view__tab);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new InfoFragment(), "ONE");
        adapter.addFragment(new InfoFragment(), "TWO");
